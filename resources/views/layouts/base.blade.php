            ...
            <div class="sidebar__contact-info mt-30">
                ...
                <ul>
                    ...
                    <li class="py-2"><i class="fa-solid fa-phone-volume"></i> <a href="tel:+233240827857">
                            +233240827857</a></li>
                    <li><i class="fa-solid fa-paper-plane "></i> <a href="mailto:accra@dillenandco.com"><span
                    ...
                    <div class="col-lg-5">
                        <div class="footer-eleven-left">
                            ...
                            <div class="input dark-area">
                                ...
                                <button class="align-content-lg-start"> <a href="{{ route('contactus') }}">Get in
                                        Touch<i class="fa-thin align-content-start fa-arrow-up-right"></i></a>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="footer-eleven-righ mb-60">
                            ...
                            <div class="footer-eleven-bottom">
                                ...
                                <p>© {{ date('Y') }}&nbsp;<a href="#0">Dillen and Company </a>, All Rights
                                    Reserved | powered by MinfInnovations</p>
                            </div>
                        </div>
                    </div>
                </div>
